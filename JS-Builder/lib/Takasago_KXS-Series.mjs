...
class Takasago_KXS_Series extends TakasagoDCPowerSupply {
...
class Takasago_KXS_100H extends Takasago_KXS_Series {
  constructor (address, serialManager) {
    super(address, serialManager);
...
class Takasago_KXS_100L extends Takasago_KXS_Series {
  constructor (address, serialManager) {
    super(address, serialManager);
...
export {Takasago_KXS_100H, Takasago_KXS_100L};
